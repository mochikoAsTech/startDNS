...
新たにサイトをオープンするとき、まだリソースレコードが用意できていないのにブラウザでサイトを開いてしまい、リソースレコードが用意できた後で再度確認しようとしたらなぜか見られない…という現象はこのネガティブキャッシュが原因です。「インフラ担当に頼んでおいたAレコード、もう用意できたかな？」と確認するときは、ネガティブキャッシュが残っても困らない環境でdigを叩いてみるのがお勧めです。
