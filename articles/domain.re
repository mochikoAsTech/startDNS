...
//image[domainWhoCanBought][取得可能ならドメイン名だけを表示して選ぼう][scale=0.8]{
//}
...
さて、ここまでドメイン名を「買う」「購入する」のように表現してきましたが、ドメイン名は本当に「買う」ものなのでしょうか？@<fn>{registration}ちょっと立ち止まって考えてみましょう。たとえば花屋さんで一輪のガーベラを買ったら、そのガーベラはあなたの物です。あなたの部屋に飾ってもいいし、他の人にあげてもいいし、瓶詰めのハーバリウムにしてメルカリで売っても構いません。ですが先ほどお名前.comで「買った」ドメイン名は、花と同じようにあなたのものなのでしょうか？これからずっといつまでも使えるのでしょうか？
...
ですので、ドメイン名は正確には「買う」ものではなく、花と違って自分の所有物にもなりません。それを踏まえた上で、本著では感覚的な分かりやすさを優先して「ドメイン名を買う」「購入したドメイン名」という表現を用いることとします。
