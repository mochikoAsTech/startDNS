...
//footnote[buyDomain][ドメイン名って「買う」ものなの？という疑問については後述しますので取りあえず進みましょう]
...
お名前.comでexample.co.jpを調べてみると、1年で3,660円@<fn>{money}でした。（@<img>{onamae3660yen}）しかも残念ながら×がついていて「登録済みドメインのため、お申込みいただけません。」となっています。@<fn>{cannotbuy}

//image[onamae3660yen][お名前.comでは3,660円][scale=0.8]{

//}

//footnote[money][ドメインの値段はすべて税別（ゴンベエドメインのみ税込）表記で、2019年8月に著者が検索した時点の金額です。]
